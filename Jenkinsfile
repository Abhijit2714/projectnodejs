pipeline {
    ...
    stages {
        ...
        stage('Push to Docker Hub') {
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: DOCKER_CREDENTIALS, url: 'https://index.docker.io/v1/', passwordVariable: 'jagannath@2714', usernameVariable: 'abhijitdhamne')]) {
